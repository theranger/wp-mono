...
?><!DOCTYPE html>
<!--[if lt IE 7 ]>
<html lang="en" class="ie6 ie">    <![endif]-->
<!--[if IE 7 ]>
<html lang="en" class="ie7 ie">    <![endif]-->
<!--[if IE 8 ]>
<html lang="en" class="ie8 ie">    <![endif]-->
<!--[if IE 9 ]>
<html lang="en" class="ie9 ie">    <![endif]-->
<!--[if (gt IE 9)|!(IE)]><!-->
...
<head>
	...
	<!-- Load stylesheets -->
	<link type="text/css" rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/screen.css"
		  media="screen"/>
	<link type="text/css" rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/print.css"
		  media="print"/>
	<?php /* Dynamic CSS from Theme Settings */
	...
	<link type="text/css" rel="apple-touch-icon"
...
<div id="outer">
	<div id="header" class="clearfix">
		<div class="container_12">
			...
			<div class="<?php echo $menu_container_left; ?>">
				<h1 id="logo">
					<?php /* Assign logo url if set 			*/
					if ($logo_url) {
						$logo_upload = $logo_url;
					} ?>
					<?php /* If text logo not set, use image 	*/
					if (!$logo_text_based) { ?><a href="<?php echo home_url(); ?>"><img
								src="<?php echo $logo_upload; ?>" alt="<?php bloginfo('name'); ?>"/></a>
						<?php /* If text logo set, use the text		*/
					} else { ?><a href="<?php echo home_url(); ?>"
								  class="textlogo"><?php echo $logo_text_based; ?></a><?php } ?>
				</h1>
			</div><!--//grid_x-->
	...
	<div id="main" class="clearfix">
		<div class="container_12">
			<?php if (is_active_sidebar('body-top')) {
				dynamic_sidebar('body-top');
			} ?>
